...
class BiosecuridDatabaseTest(unittest.TestCase):
  ...
  def test03_driver_api(self):
    ...
    self.assertEqual(main('biosecurid.hand reverse user1001/session0001/u1001s0001_pp0001 --self-test'.split()), 0)
