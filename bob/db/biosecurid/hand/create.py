  ...
  for userdir in os.listdir(imagedir):
    ...
    for sessiondir in sessiondirs:
      ...
      for filename in filenames:
        ...
        if extension == '.jpg' and 'pp' in basename:
...
def add_command(subparsers):
  ...
  parser.add_argument('-D', '--imagedir', metavar='DIR', default='/home/bob/dataHand/', help="Change the relative path to the directory containing the images of the BiosecurID database.")
